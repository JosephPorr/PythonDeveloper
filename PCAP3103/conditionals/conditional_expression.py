# A expression always returns something. A statement only exicutes, but doesn't return anything
# A conditional expression that calls one of these print functions if true and the other if false.
...
#  Assign the value returned by a conditional expression directly to the message variable.
